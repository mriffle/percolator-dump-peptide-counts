...
public class MainProgram implements Runnable {
	...
	@CommandLine.Option(names = { "-r", "--reverse" }, required = false, description = "Reverse the filters, only returns items that do NOT pass the filters.")
